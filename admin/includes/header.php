                    ...
                    <div class="top-bar">
                        ...
                        <nav id="responsive-menu">
                            <ul class="menu vertical medium-horizontal float-right" data-responsive-menu="accordion medium-dropdown">
                                <li class="single-sub parent-nav"><a href="dashboard">Home</a></li>
                                <li class="single-sub parent-nav"><a href="#"> About Us </a></li>
                                <li class="single-sub parent-nav"><a href="member-staff">Our Team</a>
                                <li class="single-sub parent-nav"><a href="#">Notices</a></li>
                                <li class="single-sub parent-nav"><a href="#">Events</a></li>
                                <li class="single-sub parent-nav"><a href="#">Gallery</a></li>
